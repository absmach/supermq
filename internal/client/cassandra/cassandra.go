...
type Config struct {
	Hosts    []string `env:"DB_CLUSTER,notEmpty"     envDefault:"127.0.0.1" envSeparator:","`
	Keyspace string   `env:"DB_KEYSPACE,notEmpty"    envDefault:"mainflux"`
	User     string   `env:"DB_USER"                 envDefault:""`
	Pass     string   `env:"DB_PASS"                 envDefault:""`
	Port     int      `env:"DB_PORT,notEmpty"        envDefault:"9042"`
}
