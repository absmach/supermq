...
type Message struct {
	...
	Occured              int64    `protobuf:"varint,6,opt,name=occured,proto3" json:"occured,omitempty"`
...
func (m *Message) GetOccured() int64 {
	if m != nil {
		return m.Occured
	}
	return 0
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	0xcb, 0x29, 0xad, 0x50, 0x5a, 0xcb, 0xc8, 0xc5, 0xee, 0x0b, 0x91, 0x13, 0x92, 0xe0, 0x62, 0x4f,
	...
	0x04, 0xe3, 0x82, 0x64, 0xf2, 0x93, 0x93, 0x4b, 0x8b, 0x52, 0x53, 0x24, 0xd8, 0x14, 0x18, 0x35,
	0x98, 0x83, 0x60, 0x5c, 0x27, 0x81, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0,
	0x48, 0x8e, 0x71, 0xc6, 0x63, 0x39, 0x86, 0x24, 0x36, 0xb0, 0x79, 0xc6, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xe5, 0x53, 0xe6, 0x15, 0xe3, 0x00, 0x00, 0x00,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Occured != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.Occured))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Payload) > 0 {
...
func (m *Message) Size() (n int) {
	...
	if m.Occured != 0 {
		n += 1 + sovMessage(uint64(m.Occured))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Occured", wireType)
			}
			m.Occured = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
