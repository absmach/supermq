...
type Message struct {
	...
	Occurred             int64    `protobuf:"varint,6,opt,name=occurred,proto3" json:"occurred,omitempty"`
...
func (m *Message) GetOccurred() int64 {
	if m != nil {
		return m.Occurred
	}
	return 0
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	0xcb, 0x29, 0xad, 0x50, 0x5a, 0xcf, 0xc8, 0xc5, 0xee, 0x0b, 0x91, 0x13, 0x92, 0xe0, 0x62, 0x4f,
	...
	0x07, 0xd9, 0x57, 0x90, 0x58, 0x99, 0x93, 0x9f, 0x98, 0x22, 0xc1, 0xaa, 0xc0, 0xa8, 0xc1, 0x13,
	0x04, 0xe3, 0x82, 0x74, 0xe5, 0x27, 0x27, 0x97, 0x16, 0x15, 0xa5, 0xa6, 0x48, 0xb0, 0x29, 0x30,
	0x6a, 0x30, 0x07, 0xc1, 0xf9, 0x4e, 0x02, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8,
	0xe0, 0x91, 0x1c, 0xe3, 0x8c, 0xc7, 0x72, 0x0c, 0x49, 0x6c, 0x60, 0x13, 0x8d, 0x01, 0x01, 0x00,
	0x00, 0xff, 0xff, 0x81, 0x36, 0x5f, 0x25, 0xe5, 0x00, 0x00, 0x00,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Occurred != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.Occurred))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Payload) > 0 {
...
func (m *Message) Size() (n int) {
	...
	if m.Occurred != 0 {
		n += 1 + sovMessage(uint64(m.Occurred))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Occurred", wireType)
			}
			m.Occurred = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
