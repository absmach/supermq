...
A copy of [Go](https://golang.org/doc/install) **(version 1.13.3)** will also need to be installed on your system.

If either of these versions seem outdated, the latest can always be found in our [CI script](https://github.com/mainflux/mainflux/blob/master/scripts/ci.sh).
