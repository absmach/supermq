...
import { Menu, X, Home, Users, Zap, Settings, Database, Globe, Sun, Moon } from 'lucide-react';
...
const DashboardLayout = ({
  ...
  return (
    <div className="flex h-screen bg-flux-bg text-flux-text">
      ...
      >
        {/* Sidebar Header */}
        <div className={`p-4 border-b border-flux-card-border flex items-center ${sidebarOpen ? 'justify-between' : 'justify-center'}`}>
          {sidebarOpen && (
            <FluxLogo className="text-2xl font-bold" />
          )}
