		...
		<div className="p-8 space-y-6">
			<div>
				...
				<p className="text-flux-text-muted">
					Monitor message storage and database metrics
				</p>
			</div>
				...
				{storageMetrics.map((metric, i) => (
					<Card key={i} className="border-flux-card-border bg-flux-card">
						<CardContent className="p-5">
							...
							<p className="text-2xl font-bold text-flux-text mb-1">
								{metric.size}
							</p>
							<p className="text-xs text-flux-text-muted mb-3">
							...
							<p className="text-xs text-flux-text-muted mt-1.5">
								{metric.usage}% used
							</p>
						</CardContent>
					</Card>
				...
				<CardContent>
					<div>
						<div className="flex justify-between mb-2">
							...
							<span className="text-flux-text font-semibold text-sm">
								4.9 GB / 10 GB
							</span>
						</div>
						<div className="w-full bg-flux-bg rounded-full h-2">
							<div
								className="bg-gradient-to-r from-flux-green to-flux-teal h-2 rounded-full"
								style={{ width: "49%" }}
							/>
						</div>
					</div>
						...
						<div className="space-y-3">
							{[
								...
								<div key={label} className="flex justify-between">
									...
									<span className="text-flux-text text-sm font-medium">
										{value}
									</span>
								</div>
							))}
