...
func (ms *metricsMiddleware) ShareAccessRight(ctx context.Context, token, thingGroupID, userGroupID string) error {
	defer func(begin time.Time) {
	...
	return ms.svc.ShareAccessRight(ctx, token, thingGroupID, userGroupID)
}
