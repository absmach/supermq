...
func (*AccessByKeyReq) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{0} }
...
func (*ThingID) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{1} }
...
func (*AccessByIDReq) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{2} }
...
func (*Token) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{3} }
...
func (*UserID) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{4} }
...
func (c *thingsServiceClient) CanAccessByKey(ctx context.Context, in *AccessByKeyReq, opts ...grpc.CallOption) (*ThingID, error) {
	out := new(ThingID)
	err := grpc.Invoke(ctx, "/mainflux.ThingsService/CanAccessByKey", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *thingsServiceClient) CanAccessByID(ctx context.Context, in *AccessByIDReq, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	err := grpc.Invoke(ctx, "/mainflux.ThingsService/CanAccessByID", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *thingsServiceClient) Identify(ctx context.Context, in *Token, opts ...grpc.CallOption) (*ThingID, error) {
	out := new(ThingID)
	err := grpc.Invoke(ctx, "/mainflux.ThingsService/Identify", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersServiceClient) Identify(ctx context.Context, in *Token, opts ...grpc.CallOption) (*UserID, error) {
	out := new(UserID)
	err := grpc.Invoke(ctx, "/mainflux.UsersService/Identify", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
