...
func TestEnableGroup(t *testing.T) {
	...
	enabledGroup1 := mfgroups.Group{ID: ID, Name: "group1", Status: mainflux.EnabledStatus}
	disabledGroup := mfgroups.Group{ID: ID, Name: "group2", Status: mainflux.DisabledStatus}
