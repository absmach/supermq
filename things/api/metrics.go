...
func (ms *metricsMiddleware) ViewThing(key string, id uint) (things.Thing, error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) RemoveThing(key string, id uint) error {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) ViewChannel(key string, id uint) (things.Channel, error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) RemoveChannel(key string, id uint) error {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) Connect(key string, chanID, thingID uint) error {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) Disconnect(key string, chanID, thingID uint) error {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) CanAccess(id uint, key string) (uint, error) {
	defer func(begin time.Time) {
...
func (ms *metricsMiddleware) Identify(key string) (uint, error) {
	defer func(begin time.Time) {
