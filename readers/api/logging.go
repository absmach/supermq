...
func (lm *loggingMiddleware) ReadAll(chanID string, offset, limit uint64, andQuery map[string]string) []mainflux.Message {
	...
	return lm.svc.ReadAll(chanID, offset, limit, andQuery)
}
