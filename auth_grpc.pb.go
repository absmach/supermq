...
const (
	...
	ThingsService_GetEntityBasic_FullMethodName    = "/magistrala.ThingsService/GetEntityBasic"
	ThingsService_GetEntitiesBasic_FullMethodName  = "/magistrala.ThingsService/GetEntitiesBasic"
	ThingsService_AddConnections_FullMethodName    = "/magistrala.ThingsService/AddConnections"
	ThingsService_RemoveConnections_FullMethodName = "/magistrala.ThingsService/RemoveConnections"
)
...
type ThingsServiceClient interface {
	...
	GetEntityBasic(ctx context.Context, in *EntityReq, opts ...grpc.CallOption) (*EntityBasic, error)
	GetEntitiesBasic(ctx context.Context, in *EntitiesReq, opts ...grpc.CallOption) (*EntitiesBasicRes, error)
	AddConnections(ctx context.Context, in *ConnectionsReq, opts ...grpc.CallOption) (*ConnectionsRes, error)
	RemoveConnections(ctx context.Context, in *ConnectionsReq, opts ...grpc.CallOption) (*ConnectionsRes, error)
}
...
func (c *thingsServiceClient) GetEntityBasic(ctx context.Context, in *EntityReq, opts ...grpc.CallOption) (*EntityBasic, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EntityBasic)
	err := c.cc.Invoke(ctx, ThingsService_GetEntityBasic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *thingsServiceClient) GetEntitiesBasic(ctx context.Context, in *EntitiesReq, opts ...grpc.CallOption) (*EntitiesBasicRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EntitiesBasicRes)
	err := c.cc.Invoke(ctx, ThingsService_GetEntitiesBasic_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *thingsServiceClient) AddConnections(ctx context.Context, in *ConnectionsReq, opts ...grpc.CallOption) (*ConnectionsRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConnectionsRes)
...
func (c *thingsServiceClient) RemoveConnections(ctx context.Context, in *ConnectionsReq, opts ...grpc.CallOption) (*ConnectionsRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConnectionsRes)
...
type ThingsServiceServer interface {
	...
	GetEntityBasic(context.Context, *EntityReq) (*EntityBasic, error)
	GetEntitiesBasic(context.Context, *EntitiesReq) (*EntitiesBasicRes, error)
	AddConnections(context.Context, *ConnectionsReq) (*ConnectionsRes, error)
	RemoveConnections(context.Context, *ConnectionsReq) (*ConnectionsRes, error)
...
func (UnimplementedThingsServiceServer) GetEntityBasic(context.Context, *EntityReq) (*EntityBasic, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEntityBasic not implemented")
}
func (UnimplementedThingsServiceServer) GetEntitiesBasic(context.Context, *EntitiesReq) (*EntitiesBasicRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEntitiesBasic not implemented")
}
func (UnimplementedThingsServiceServer) AddConnections(context.Context, *ConnectionsReq) (*ConnectionsRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddConnections not implemented")
}
func (UnimplementedThingsServiceServer) RemoveConnections(context.Context, *ConnectionsReq) (*ConnectionsRes, error) {
...
func _ThingsService_GetEntityBasic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EntityReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThingsServiceServer).GetEntityBasic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ThingsService_GetEntityBasic_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThingsServiceServer).GetEntityBasic(ctx, req.(*EntityReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _ThingsService_GetEntitiesBasic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EntitiesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThingsServiceServer).GetEntitiesBasic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ThingsService_GetEntitiesBasic_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThingsServiceServer).GetEntitiesBasic(ctx, req.(*EntitiesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ThingsService_AddConnections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThingsServiceServer).AddConnections(ctx, req.(*ConnectionsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ThingsService_RemoveConnections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThingsServiceServer).RemoveConnections(ctx, req.(*ConnectionsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ThingsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetEntityBasic",
			Handler:    _ThingsService_GetEntityBasic_Handler,
		},
		{
			MethodName: "GetEntitiesBasic",
			Handler:    _ThingsService_GetEntitiesBasic_Handler,
		},
		{
