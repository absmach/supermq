...
func (_m *Service) IssueToken(ctx context.Context, identity string, secret string, domainID string) (*v1.Token, error) {
	...
	var r0 *v1.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (*v1.Token, error)); ok {
		return rf(ctx, identity, secret, domainID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) *v1.Token); ok {
...
func (_m *Service) RefreshToken(ctx context.Context, session authn.Session, refreshToken string, domainID string) (*v1.Token, error) {
	...
	var r0 *v1.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, authn.Session, string, string) (*v1.Token, error)); ok {
		return rf(ctx, session, refreshToken, domainID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, authn.Session, string, string) *v1.Token); ok {
