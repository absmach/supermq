...
type Service interface {
	...
	IssueToken(ctx context.Context, identity, secret, domainID string) (*grpcTokenV1.Token, error)
	...
	RefreshToken(ctx context.Context, session authn.Session, refreshToken, domainID string) (*grpcTokenV1.Token, error)
