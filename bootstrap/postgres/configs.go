...
var (
	errSaveDB           = errors.New("fail to save bootstrap configuration to database")
	errMarshalChannel   = errors.New("fail to marshal channel into json")
	errUnmarshalChannel = errors.New("fail to unmarshal json to channel")
	errSaveChannels     = errors.New("fail to insert channels to database")
	errSaveConnections  = errors.New("fail to insert connections to database")
	errRemoveUnknown    = errors.New("fail to remove from uknown configurations in database")
	errSaveUnknown      = errors.New("fail to insert into uknown configurations in database")
	errRetrieve         = errors.New("fail to retreive bootstrap configuration from database")
	errUpdate           = errors.New("fail to update bootstrap configuration in database")
	errRemove           = errors.New("fail to remove bootstrap configuration from database")
	errUpdateChannels   = errors.New("fail to update channels in bootstrap configuration database")
	errRemoveChannels   = errors.New("fail to remove channels from bootstrap configuration in database")
	errDisconnectThing  = errors.New("fail to disconnect thing in bootstrap configuration in database")
)
