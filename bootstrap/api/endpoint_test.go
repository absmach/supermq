...
var (
	...
	// missingIDRes  = toJSON(apiutil.ErrorRes{Err: errors.Wrap(errors.ErrNotFound, apiutil.ErrMissingID).Error()})
	// missingKeyRes = toJSON(apiutil.ErrorRes{Err: errors.Wrap(errors.ErrNotFound, apiutil.ErrBearerKey).Error()})
)
