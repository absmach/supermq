...
func (lm *loggingMiddleware) Bootstrap(externalKey, externalID string, encrypted bool) (cfg bootstrap.Config, err error) {
	defer func(begin time.Time) {
	...
	return lm.svc.Bootstrap(externalKey, externalID, encrypted)
}
