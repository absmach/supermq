...
func TestCreateUser(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			user:  user,
			token: token,
			err:   errors.NewSDKErrorWithStatus(errors.ErrConflict.Error(), http.StatusConflict),
		},
		{
		...
		},
		{
			...
			token: token,
			err:   errors.NewSDKErrorWithStatus(users.ErrPasswordFormat.Error(), http.StatusBadRequest),
		},
		{
