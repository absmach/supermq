...
func (_mock *SDK) SendMessage(ctx context.Context, domainID string, topic string, key string, msg string) errors.SDKError {
	ret := _mock.Called(ctx, domainID, topic, key, msg)
	...
	var r0 errors.SDKError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, string) errors.SDKError); ok {
		r0 = returnFunc(ctx, domainID, topic, key, msg)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(errors.SDKError)
		}
...
//   - key
//   - msg
func (_e *SDK_Expecter) SendMessage(ctx interface{}, domainID interface{}, topic interface{}, key interface{}, msg interface{}) *SDK_SendMessage_Call {
	return &SDK_SendMessage_Call{Call: _e.mock.On("SendMessage", ctx, domainID, topic, key, msg)}
}

func (_c *SDK_SendMessage_Call) Run(run func(ctx context.Context, domainID string, topic string, key string, msg string)) *SDK_SendMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(string), args[4].(string))
	})
	return _c
...
func (_c *SDK_SendMessage_Call) RunAndReturn(run func(ctx context.Context, domainID string, topic string, key string, msg string) errors.SDKError) *SDK_SendMessage_Call {
	_c.Call.Return(run)
	return _c
}
