...
func newService(db *sqlx.DB, tracer trace.Tracer, c config, ec email.Config, logger logger.Logger) (clients.Service, groups.GroupService, policies.PolicyService) {
