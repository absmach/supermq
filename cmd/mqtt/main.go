...
func proxyMQTT(cfg config, logger logger.Logger, evt session.EventHandler, errs chan error) {
...
func proxyWS(cfg config, logger logger.Logger, evt session.EventHandler, errs chan error) {
