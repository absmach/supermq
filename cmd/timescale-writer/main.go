...
type config struct {
	LogLevel   string `env:"MF_TIMESCALE_WRITER_LOG_LEVEL,notEmpty"   envDefault:"info"`
	ConfigPath string `env:"MF_TIMESCALE_WRITER_CONFIG_PATH,notEmpty" envDefault:"/config.toml"`
