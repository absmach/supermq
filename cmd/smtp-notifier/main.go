...
type config struct {
	LogLevel   string `env:"MF_SMTP_NOTIFIER_LOG_LEVEL,notEmpty"   envDefault:"info"`
	ConfigPath string `env:"MF_SMTP_NOTIFIER_CONFIG_PATH,notEmpty" envDefault:"/config.toml"`
	...
	JaegerURL  string `env:"MF_JAEGER_UR,notEmptyL"                envDefault:"localhost:6831"`
}
